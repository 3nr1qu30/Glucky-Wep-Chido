...
function myFunction3() {
  ...
  function myFunction6() {
	...
	tr = table.getElementsByTagName("tr");
	for (i = 0; i < tr.length; i++) {
	  td = tr[i].getElementsByTagName("td")[5];  /*Lo que está dentro del arreglo delimita el buscador */
	  if (td) {
		txtValue = td.textContent || td.innerText;
		if (txtValue.toUpperCase().indexOf(filter) > -1) {
		  tr[i].style.display = "";
  ...
  function myFunction7() {
	...
	tr = table.getElementsByTagName("tr");
	for (i = 0; i < tr.length; i++) {
	  td = tr[i].getElementsByTagName("td")[6];  /*Lo que está dentro del arreglo delimita el buscador */
	  if (td) {
		txtValue = td.textContent || td.innerText;
		if (txtValue.toUpperCase().indexOf(filter) > -1) {
		  tr[i].style.display = "";
...
let circle = document.querySelector(".color-option");
   ...
   const section2 = document.querySelector("section"),
        ...
        showBtn2 = document.querySelector(".botonver2"),  /*Botón para ver */
        closeBtn2 = document.querySelector(".");
